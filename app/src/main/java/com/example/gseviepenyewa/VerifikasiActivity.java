...
import com.example.gseviepenyewa.Adapter.VerifikasiAdapter;
...
public class VerifikasiActivity extends AppCompatActivity {
    ...
    public void tampilPemesanan(){
        ...
        Call<GetPesan> mPemesananCall = mApiInterface.getVerifikasi(reqid_user);
        ...
        mPemesananCall.enqueue(new Callback<GetPesan>() {
            ...
            public void onResponse(Call<GetPesan> call, Response<GetPesan> response) {
                if(response.body(). getStatus().equals("success")){
                    ...
                    mAdapter = new VerifikasiAdapter(daftarPemesanan);
