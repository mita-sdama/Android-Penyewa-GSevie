...
import com.example.gseviepenyewa.Adapter.RiwayatDetailAdapter;
...
public class RiwayatDetailActivity extends AppCompatActivity {
    ...
    TextView totalBayar, denda, keterangan;
    String code = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        denda = (TextView) findViewById(R.id.denda);
        ...
        Call<GetPesan> mDenda= mApiInterface.getDenda(reqid_detail);
        mDenda.enqueue(new Callback<GetPesan>() {
            @Override
            public void onResponse(Call<GetPesan> call, Response<GetPesan> response) {
               if (response.body().getStatus().equals("success")){
                   ...
                   denda.setText(formatRupiah.format(harga));
            ...
            public void onResponse(Call<UniqueCode> call, Response<UniqueCode> response) {
                ...
                call2.enqueue(new Callback<Data>() {
                    ...
                    public void onResponse(Call<Data> call, Response<Data> response) {
                        ...
                        Call<GetPesan> mPemesananCall = mApiInterface.detailRiwayat(reqid_detail);
                ...
                Call<GetPesan> PemesananCall = mApiInterface.detailRiwayat(detail);
                ...
                Call<GetPesan> PemesananCall2 = mApiInterface.detailRiwayat(detail2);
    ...
    private void tampilPemesanan(){
        ...
        mPemesananCall.enqueue(new Callback<GetPesan>() {
            ...
            public void onResponse(Call<GetPesan> call, Response<GetPesan> response) {
                ...
                mAdapter = new RiwayatDetailAdapter(tampilPesan, RiwayatDetailActivity.this);
