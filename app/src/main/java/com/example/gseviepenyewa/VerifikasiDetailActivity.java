...
import com.example.gseviepenyewa.Adapter.VerifikasiDetailAdapter;
...
public class VerifikasiDetailActivity extends AppCompatActivity {
    Context mContext;
            ...
            public void onResponse(Call<UniqueCode> call, Response<UniqueCode> response) {
                ...
                call2.enqueue(new Callback<Data>() {
                    ...
                    public void onResponse(Call<Data> call, Response<Data> response) {
                        ...
                        Call<GetPesan> mPemesananCall = mApiInterface.detailVerifikasi(reqid_detail);
                ...
                Call<GetPesan> PemesananCall = mApiInterface.detailVerifikasi(detail);
                ...
                Call<GetPesan> PemesananCall2 = mApiInterface.detailVerifikasi(detail2);
    ...
    private void tampilPemesanan(){
        ...
        mPemesananCall.enqueue(new Callback<GetPesan>() {
            ...
            public void onResponse(Call<GetPesan> call, Response<GetPesan> response) {
                ...
                mAdapter = new VerifikasiDetailAdapter(tampilPesan);
