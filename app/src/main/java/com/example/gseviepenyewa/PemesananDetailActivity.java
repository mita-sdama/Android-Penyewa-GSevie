...
public class PemesananDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadBukti = (Button) findViewById(R.id.upload_bukti);
            ...
            public void onResponse(Call<UniqueCode> call, Response<UniqueCode> response) {
                ...
                call2.enqueue(new Callback<Data>() {
                    ...
                    public void onResponse(Call<Data> call, Response<Data> response) {
                        ...
                        Call<GetPesan> mPemesananCall = mApiInterface.detailPesan(reqid_detail);
                ...
                Call<GetPesan> PemesananCall = mApiInterface.detailPesan(detail);
                ...
                Call<GetPesan> PemesananCall2 = mApiInterface.detailPesan(detail2);
    ...
    private void tampilPemesanan(){
        ...
        mPemesananCall.enqueue(new Callback<GetPesan>() {
            ...
            public void onResponse(Call<GetPesan> call, Response<GetPesan> response) {
                ...
                mAdapter = new PemesananDetailAdapter(tampilPesan);
